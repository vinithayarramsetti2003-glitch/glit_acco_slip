...
# ==========================================
# BRONZE LAYER
# - Read RAW (CSV) from Blob (ATM + UPI)
# - Add minimal technical metadata
# - Write Delta to bronze containers
# ==========================================
...
# ------------------------------------------
# 2. SCHEMAS (ADJUST COLUMN NAMES IF NEEDED)
# ------------------------------------------
...
# ------------------------------------------
# 5. MANUAL ENTRY POINT (UNCOMMENT TO RUN)
# ------------------------------------------

# run_bronze_atm_batch()
# run_bronze_upi_batch()