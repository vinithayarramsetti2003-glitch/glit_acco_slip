# ==========================================
# SILVER LAYER
# - Read Bronze Delta (ATM + UPI)
# - Clean / standardize
# - Normalize to unified transaction shape
# - Write Delta to silver containers
# ==========================================
...
# ------------------------------------------
# 5. MANUAL ENTRY POINT
# ------------------------------------------

# build_silver_atm()
# build_silver_upi()
# build_unified_silver_transactions()